...
Do not modify or delete files inside any skill that is a symlink (symlinks point into `/srv/storage/roboserver1/home/anhar/codes/Auto-claude-code-research-in-sleep`).
Update with: `bash /srv/storage/roboserver1/home/anhar/codes/Auto-claude-code-research-in-sleep/tools/install_aris.sh`  (re-runnable; reconciles new/removed skills).
<!-- ARIS:END -->